...
public class AbstractAnalyserTable extends SortedTable {
	...
	public Component getTableCellRendererComponent(JTable table,
						       ...
						       boolean hasFocus,
						       int row, int column) {
	    AbstractAnalyserTable t = (AbstractAnalyserTable) table;
	...
	public void checkPopup(MouseEvent e) {
	    ...
	    //    if (e.isPopupTrigger()) 
	    ///		AnalyserTable.popup.show(this, e.getX(), e.getY());
	}
