...
public class PreferencesSettingsWriter implements SettingsWriter {
    
    public PreferencesSettingsWriter() {
	...
	//Eventually, we may merge the preferences and settings by placing
	//the preferences.putPreferences code here. 
    }
}