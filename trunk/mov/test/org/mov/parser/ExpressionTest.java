...
public class ExpressionTest extends TestCase {
    ...
    private Expression parse(String string) {
        try {
            ...
            variables.add("x", Expression.INTEGER_TYPE);
            variables.add("y", Expression.INTEGER_TYPE);
            variables.add("a", Expression.BOOLEAN_TYPE);
            variables.add("b", Expression.BOOLEAN_TYPE);
            variables.add("c", Expression.BOOLEAN_TYPE);
