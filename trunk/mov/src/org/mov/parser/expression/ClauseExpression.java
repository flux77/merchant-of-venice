...
/**
 * A clause is an ordered list of sub-expressions. Each sub-expression is executed serially. The
 * value and type of the clause is the value and type of the last sub-expression in the clause.
 */
public class ClauseExpression extends AbstractExpression {
	...
	// Execute all the sub-expressions in this clause and return the value of
    ...
    /**
     * A helper method to use when printing expressions that might be either sub-expressions
     * or clause expressions. For example the "if" expression, ignoring the else clause, could be
     * printed in two ways:
     * <pre>
     * if(x) {
     *    statement1
     ...
     * if(x)
     *    statement
     * </pre>Which one will depend on whether the expression is a clause or a sub-expression.
     * This function analyses the given expression and makes sure it is printed correctly.
     *
