...
/**
 * An expression which finds the SD (Standard Deviation) over a given trading period.
 *
 * @author Alberto Nacher
 */
public class SDExpression extends TernaryExpression {
     ...
     */
    public SDExpression(Expression quote, Expression days, Expression lag) {
    ...
    public Object clone() {
        return new SDExpression((Expression)getChild(0).clone(), 
