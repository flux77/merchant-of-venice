...
public class QuoteRangeTest extends TestCase 
{
    public void testOverlapRange() {

        QuoteRange quoteRange, quoteRange2, clippedQuoteRange;

        // Test Partial Overlap
        //
        // quoteRange      [----------]   
        // quoteRange2  [----------]    -> [-]  
        quoteRange = new QuoteRange("CBA", new TradingDate(2000, 1, 1),
                                    new TradingDate(2000, 12, 1));
        quoteRange2 = new QuoteRange("CBA", new TradingDate(1999, 1, 1),
        ...
        quoteRange = new QuoteRange("CBA", new TradingDate(2000, 1, 1),
                                    new TradingDate(2000, 12, 1));
        quoteRange2 = new QuoteRange("CBA", new TradingDate(2000, 1, 1),
                                     new TradingDate(2000, 12, 1));
        clippedQuoteRange = quoteRange2.clip(quoteRange); 
        ...
        quoteRange = new QuoteRange("CBA", new TradingDate(2000, 1, 1),
                                    new TradingDate(2000, 12, 1));
        quoteRange2 = new QuoteRange("CBA", new TradingDate(2000, 3, 1),
        ...
        // quoteRange       [--]        -> null
        // quoteRange2  [----------]    
        quoteRange = new QuoteRange("CBA", new TradingDate(2000, 3, 1),
                                    new TradingDate(2000, 9, 1));
        quoteRange2 = new QuoteRange("CBA", new TradingDate(2000, 1, 1),
                                     new TradingDate(2000, 12, 1));
        clippedQuoteRange = quoteRange2.clip(quoteRange); 
